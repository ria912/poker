...
const NewGameForm = ({ onNewGame, loading }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const players = [
            ...
            { name: 'Alice', stack: 1000, is_ai: true },
            { name: 'Bob', stack: 1000, is_ai: true },
            { name: 'Charlie', stack: 1000, is_ai: true },
            { name: 'Dave', stack: 1000, is_ai: true },
            { name: 'Eve', stack: 1000, is_ai: true },
        ];
        onNewGame(players);
    };
